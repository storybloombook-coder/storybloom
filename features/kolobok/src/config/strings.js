    ...
    sound: {
      ...
      slot: {
        kolobok: {
          roll: 'Rolling',
          hop: 'Hop',
          songNote1: 'Song note (do)',
          songNote2: 'Song note (re)',
          songNote3: 'Song note (mi)',
          songNote4: 'Song note (sol)',
          songNote5: 'Song note (la)',
          songLine: 'Song line ("I ran away...")',
          hum: 'Road humming',
    ...
    sound: {
      ...
      slot: {
        kolobok: {
          roll: 'Качение',
          hop: 'Прыжок',
          songNote1: 'Нота песни (до)',
          songNote2: 'Нота песни (ре)',
          songNote3: 'Нота песни (ми)',
          songNote4: 'Нота песни (соль)',
          songNote5: 'Нота песни (ля)',
          songLine: 'Строчка песни («Я от бабушки ушёл...»)',
