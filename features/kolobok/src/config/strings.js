...
export const STRINGS = {
  en: {
    ...
    ui: {
      ...
      openControls: 'Show the scene controls',
      closeControls: 'Hide the scene controls',
      mainMenu: 'Main menu',
    ...
    sound: {
      ...
      recording: {
        ...
        analyzing: 'Reading the recording…',
        trimHint: 'Drag to pick the part you want',
        retake: 'Record again',
        confirm: 'Use this part',
  ...
  ru: {
    ...
    ui: {
      ...
      openControls: 'Показать элементы управления',
      closeControls: 'Скрыть элементы управления',
    ...
    sound: {
      ...
      recording: {
        ...
        analyzing: 'Читаем запись…',
        trimHint: 'Перетащите, чтобы выбрать нужную часть',
        retake: 'Записать заново',
        confirm: 'Использовать эту часть',
